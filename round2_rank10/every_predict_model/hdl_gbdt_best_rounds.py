...
def gbdt_model(df, label, use_feature, true_test, submission_data):
    ...
    gbdt_model_1 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1972, max_depth=5, subsample=0.7,
    ...
    gbdt_model_2 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=2000, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_3 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=2000, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_4 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1492, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_5 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1954, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
...
# b-board
# 1972 2000 2000 1492 1954 
# 'hdl': 0.010681349752220548
if __name__ == "__main__":
    train = odps.get_table('hdl_juz_train_6_6_snp_onehot_22').to_df().to_pandas()
    test = odps.get_table('hdl_juz_test_6_6_snp_onehot_22').to_df().to_pandas()
    print(train.shape)
    print(test.shape)
    ...
    sub_final.persist('hdl_jz_5_fold_6_6_submit_22')