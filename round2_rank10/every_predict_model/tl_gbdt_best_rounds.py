...
def gbdt_model(df, label, use_feature, true_test, submission_data):
    ...
    gbdt_model_1 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1777, max_depth=5, subsample=0.7,
    ...
    gbdt_model_2 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1795, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_4 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1419, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_5 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1800, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
...
# b-board
# 1777 1795 1800 1419 1800
# 'tl': 0.086486107163495141
if __name__ == "__main__":
    train = odps.get_table('tl_juz_train_6_6_snp_onehot_22').to_df().to_pandas()
    test = odps.get_table('tl_juz_test_6_6_snp_onehot_22').to_df().to_pandas()
    print(train.shape)
    print(test.shape)
    ...
    sub_final.persist('tl_jz_5_fold_6_6_submit_22')