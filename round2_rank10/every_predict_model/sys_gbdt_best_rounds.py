...
def gbdt_model(df, label, use_feature, true_test, submission_data):
    ...
    gbdt_model_1 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=624, max_depth=5, subsample=0.7,
    ...
    gbdt_model_2 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=902, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_3 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=911, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_4 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=535, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_5 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=533, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
...
# b-board
# 624 902 911 535 533
# 'sys': 0.013720952232896292
if __name__ == "__main__":
    train = odps.get_table('sys_juz_train_6_6_snp_onehot_22').to_df().to_pandas()
    test = odps.get_table('sys_juz_test_6_6_snp_onehot_22').to_df().to_pandas()
    print(train.shape)
    print(test.shape)
    ...
    sub_final.persist('sys_jz_5_fold_6_6_submit_22')