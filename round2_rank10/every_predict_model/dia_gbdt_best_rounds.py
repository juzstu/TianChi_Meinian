...
def gbdt_model(df, label, use_feature, true_test, submission_data):
    ...
    gbdt_model_1 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=739, max_depth=5, subsample=0.7,
    ...
    gbdt_model_2 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=601, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_3 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=887, max_depth=5, subsample=0.7,
                                              random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_4 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=709, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
    ...
    gbdt_model_5 =  GradientBoostingRegressor(learning_rate=0.01, n_estimators=1221, max_depth=5, subsample=0.7,
                                               random_state=1, verbose=0, min_samples_leaf=50)
...
# b-board
# 739 601 887 709 1221
# 'dia': 0.018069628693683809
if __name__ == "__main__":
    train = odps.get_table('dia_juz_train_6_6_snp_onehot_22').to_df().to_pandas()
    test = odps.get_table('dia_juz_test_6_6_snp_onehot_22').to_df().to_pandas()
    print(train.shape)
    print(test.shape)
    ...
    sub_final.persist('dia_jz_5_fold_6_6_submit_22')